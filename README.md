...
Once the image has finished building, the command *s2i usage nginx-centos7* will print out the help info that was defined in the *usage* script.
...
### apply to kubectl
```
kubectl apply -f s2ibuilder-nginx.yaml
```